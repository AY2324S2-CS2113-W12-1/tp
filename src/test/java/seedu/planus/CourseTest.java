...
public class CourseTest {
    @Test
    public void getYearAndTerm_termOneOrTwo_semester() throws Exception {
    ...
    @Test
    public void getYearAndTerm_termThreeOrFour_specialTerm() throws Exception {
    ...
    @Test
    public void getModularCredit_notProvided_default4ModularCredit() throws Exception {
